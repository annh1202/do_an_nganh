...
const DangChuan = () => {
    ...
    const [danhSachDangChuan, setDanhSachDangChuan] = useState([]);
    ...
    const thuocTinhApi = TapThuocTinhApi("/dang-chuan");
    ...
    const phuThuocHamApi = TapPhuThuocHamApi("/dang-chuan");
    ...
    const chucNangApi = ChucNangChinhApi("/dang-chuan");
    ...
    const chonTaiVe = () => {
        try {
            ...
            link.href = url;
            link.download = `dang_chuan_${Date.now()}.json`;
    ...
    useEffect(() => {
        const fetchState = async () => {
            try {
                const phanHoi = await TrangThaiApi.fetchTrangThaiDangChuan();
                const doiTuong = phanHoi.data.doi_tuong;
                setTapThuocTinh(doiTuong.tap_thuoc_tinh);
                setTapPhuThuocHam(doiTuong.tap_phu_thuoc_ham);
                setDangChuan(doiTuong.dang_chuan);
    ...
    return (
        <div className="container py-3">
            ...
            <ChonDangChuan
                dangChuan={dangChuan}
                danhSachDangChuan={danhSachDangChuan}
